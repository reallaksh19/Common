...
- `../grade9-learning-enrichment/SKILL.md` for hint/misconception diagnostics;
- `../grade9-transfer-coverage-auditor/SKILL.md` for external-question completeness;
...
Emit this record before publication:
