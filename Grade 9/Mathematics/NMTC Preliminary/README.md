...
No chapter is publishable until available relevant Preliminary questions have been:

1. source-classified;
2. assigned stable IDs;
3. fingerprinted at mathematical-mechanism level;
4. clustered into archetypes;
5. mapped to concept teaching;
...
## Current recurrence signal

Operational five-year primary-domain share in the eligible 135-question set:
...
Strong cross-year mechanisms include:

- transform before calculate;
- radical/exponent/log compression;
- divisibility/modular/digit structure;
- short geometry recognition chains;
- inequality/bound/equality structure;
- polynomial/root/remainder/Vieta network.
...
- `01_PYQ_Corpus/` — question-level fingerprints, qualifications and recurrence.
