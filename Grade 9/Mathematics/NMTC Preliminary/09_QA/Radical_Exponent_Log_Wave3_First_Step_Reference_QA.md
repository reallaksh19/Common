...
Authoritative compression artifact: `Radical_Exponent_Log_First_Step_Reference_v2.md`.

PASS: created after Wave-2 teaching; 17-code atlas; phrase decoder; quick decision tree; 16 cards; trap/repair layer; source map; 24 recognition prompts; independent 24/24 audit; `EM` exponent-meaning separation; decision boundaries; reversibility/domain compression; source custody; upstream-evidence preservation.
