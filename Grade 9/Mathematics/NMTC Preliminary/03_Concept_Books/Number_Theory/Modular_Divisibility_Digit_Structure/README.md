# Modular Arithmetic, Divisibility & Digit Structure — NMTC Bhaskara Preliminary P0

## Why this unit exists

The qualified Preliminary corpus repeatedly asks the learner to compress integer information before calculating.

The recurring behavior is:
...
1. interpret congruence as compressed remainder language;
2. add, subtract and multiply congruences safely;
...
`RECOGNIZE -> COMPRESS -> FIRST MOVE -> RECONSTRUCT -> CHECK -> TRANSFER`

## Package files

- `Modular_Divisibility_Digit_Concept_Book_Spec.md`
- `Modular_Divisibility_Digit_Source_Coverage_Map.md`
- `Modular_Divisibility_Digit_Student_Draft_v0.1.md`
- `../../../04_First_Step_Reference/P0_Number_Theory_First_Step_Cards.md`
- `../../../05_Practice_Ladders/P0_Number_Theory_Modular_Divisibility_Digit_Ladder.md`
- `../../../06_Speed_Labs/P0_Number_Theory_Recognition_Lab_v1.md`
- `../../../06_Speed_Labs/P0_Number_Theory_First_Line_Lab_v1.md`
- `../../../07_Mastery_Banks/P0_Number_Theory_Modular_Divisibility_Digit_Transfer_Bank_v1.md`
