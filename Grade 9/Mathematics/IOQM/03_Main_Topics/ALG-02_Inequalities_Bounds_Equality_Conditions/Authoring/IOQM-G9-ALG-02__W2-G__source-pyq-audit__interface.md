...
## A. Scope boundary
Included: stable source/key custody, independent answer reconstruction and ownership drift checks. Excluded: Vieta/discriminant/root-feasibility canon, which remains with the polynomial owner, and prerequisite algebraic transformation teaching.
...
historical source mechanisms do not move canonical ownership between inequality and polynomial topics. Every extremum claim must pass `BOUND -> EQUALITY -> ATTAINMENT`, followed by a discrete filter when the domain requires it.
...
IOQM-2025-Q07; IOQM-2024-Q06. Exact source custody and independent reconstruction are recorded in the source map/audit.
