...
> **What exactly must be extreme, over which domain, and in which direction?**

```text
REQUEST -> DOMAIN -> BOUNDED? -> DIRECTION -> REPRESENTATION
        -> BOUND -> EQUALITY -> ATTAINMENT -> DISCRETE FILTER -> CHECK
```
