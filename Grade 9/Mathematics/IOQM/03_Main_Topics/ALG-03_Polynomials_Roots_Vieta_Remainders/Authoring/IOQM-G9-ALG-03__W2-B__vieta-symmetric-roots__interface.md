...
microstream_id: W2-B
microstream_title: Vieta and symmetric root invariants
...
## A. Scope boundary
Included: derive Vieta once from factor expansion and use symmetric invariants without unnecessary root solving. Excluded: canonical inequality/equality/attainment teaching and prerequisite transformation canon.
...
for ax^2+bx+c with roots alpha,beta: alpha+beta=-b/a and alpha beta=c/a. The governing principle is `REQUESTED INFORMATION -> CHEAPEST VALID REPRESENTATION -> CALCULATION -> CHECK`.
...
IOQM-2025-Q16; IOQM-2023-Q12. Exact paper/key custody and independent reconstruction are recorded in the source coverage and mathematics audit.
