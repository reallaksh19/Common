...
microstream_id: W2-E
microstream_title: Remainder and factor theorem
...
## A. Scope boundary
Included: evaluation as the canonical remainder on division by x-a and the zero test for a linear factor. Excluded: canonical inequality/equality/attainment teaching and prerequisite transformation canon.
...
P(x)=(x-a)Q(x)+r implies r=P(a); x-a is a factor iff P(a)=0. The governing principle is `REQUESTED INFORMATION -> CHEAPEST VALID REPRESENTATION -> CALCULATION -> CHECK`.
