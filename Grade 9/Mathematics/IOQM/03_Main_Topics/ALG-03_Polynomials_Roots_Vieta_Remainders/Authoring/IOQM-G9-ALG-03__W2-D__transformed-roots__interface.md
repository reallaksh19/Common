...
microstream_id: W2-D
microstream_title: Transformed roots and shifted input
...
## A. Scope boundary
Included: build polynomials for shifted/scaled root sets while controlling the sign reversal between root shift and input shift. Excluded: canonical inequality/equality/attainment teaching and prerequisite transformation canon.
...
roots shifted by +c are produced by P(x-c), not P(x+c). The governing principle is `REQUESTED INFORMATION -> CHEAPEST VALID REPRESENTATION -> CALCULATION -> CHECK`.
...
IOQM-2024-Q24. Exact paper/key custody and independent reconstruction are recorded in the source coverage and mathematics audit.
