...
microstream_id: W2-F
microstream_title: Polynomial reduction and high powers
...
## A. Scope boundary
Included: reduce high powers modulo a low-degree polynomial relation rather than expanding or solving roots unnecessarily. Excluded: canonical inequality/equality/attainment teaching and prerequisite transformation canon.
...
a degree-d relation reduces every polynomial to a remainder of degree < d. The governing principle is `REQUESTED INFORMATION -> CHEAPEST VALID REPRESENTATION -> CALCULATION -> CHECK`.
