...
microstream_id: W2-A
microstream_title: Polynomial representations and request routing
...
## A. Scope boundary
Included: coefficient, factor/root, evaluation and remainder-class representations chosen by requested information. Excluded: canonical inequality/equality/attainment teaching and prerequisite transformation canon.
...
coefficients, factors, roots and remainder classes describe the same polynomial object but expose different targets. The governing principle is `REQUESTED INFORMATION -> CHEAPEST VALID REPRESENTATION -> CALCULATION -> CHECK`.
...
IOQM-2025-Q16; IOQM-2024-Q24. Exact paper/key custody and independent reconstruction are recorded in the source coverage and mathematics audit.
