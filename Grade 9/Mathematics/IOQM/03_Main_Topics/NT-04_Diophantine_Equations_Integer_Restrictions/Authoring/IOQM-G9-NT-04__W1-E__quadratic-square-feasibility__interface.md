...
microstream_id: W1-E
microstream_title: Quadratic / Perfect-Square Feasibility
...
# Quadratic / Perfect-Square Feasibility - Research Interface

## A. Scope boundary
Included: discriminant-square bridge, completing square to fixed product.

Excluded: canonical discriminant/Vieta teaching. Overlap mechanisms remain with their declared canonical owners and appear here only as retrieval or a narrow bridge.
...
OWNERSHIP_TARGET: Quadratic / Perfect-Square Feasibility as part of one integrated topic journey.

## C. Mathematical invariant / governing structure
**integer quadratic solutions require discrete square/divisibility feasibility beyond real-root existence**
