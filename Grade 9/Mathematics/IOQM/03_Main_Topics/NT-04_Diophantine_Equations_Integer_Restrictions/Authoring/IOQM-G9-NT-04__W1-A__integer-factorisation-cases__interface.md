...
microstream_id: W1-A
microstream_title: Integer Factorisation into Cases
...
# Integer Factorisation into Cases - Research Interface

## A. Scope boundary
Included: shifted products, signed divisor pairs, reconstruction.

Excluded: generic algebra factorisation teaching or prime-factorisation canon. Overlap mechanisms remain with their declared canonical owners and appear here only as retrieval or a narrow bridge.
...
OWNERSHIP_TARGET: Integer Factorisation into Cases as part of one integrated topic journey.

## C. Mathematical invariant / governing structure
**fixed integer products turn algebraic factors into a complete divisor-case parametrisation**
