...
microstream_id: W1-G
microstream_title: Source / PYQ Audit
...
# Source / PYQ Audit - Research Interface

## A. Scope boundary
Included: stable IDs, final-key custody, correction overlay.

Excluded: using stale classifier strings or provisional keys. Overlap mechanisms remain with their declared canonical owners and appear here only as retrieval or a narrow bridge.
...
OWNERSHIP_TARGET: Source / PYQ Audit as part of one integrated topic journey.

## C. Mathematical invariant / governing structure
**historical anchors are evidence only after exact source/key/overlay and independent-answer custody agree**
...
|---|---|---|---|---|---|---|
| IOQM-2025-Q03 | 2025/Q03 | CLEAN_OFFICIAL | PRIMARY | factor pairs;integer optimization | no | FINAL_OFFICIAL |
| IOQM-2025-Q11 | 2025/Q11 | KEY_CORRECTED | PRIMARY | rational approximation;coprime denominator bound | no | FINAL_OFFICIAL |
| IOQM-2024-Q13 | 2024/Q13 | CLEAN_OFFICIAL | PRIMARY | Diophantine factorization;integer system | no | OFFICIAL_HBCSE_KEY |
| IOQM-2023-Q03 | 2023/Q03 | CLEAN_VALIDATED | PRIMARY | rational approximation;integer inequalities | no | HBCSE_LINKED_MTAI_EMBEDDED_KEY |
| IOQM-2023-Q04 | 2023/Q04 | CLEAN_VALIDATED | PRIMARY | Diophantine factorization;divisibility | no | HBCSE_LINKED_MTAI_EMBEDDED_KEY |
| IOQM-2023-Q11 | 2023/Q11 | CLEAN_VALIDATED | PRIMARY | quadratic Diophantine;factorization;bounds | no | HBCSE_LINKED_MTAI_EMBEDDED_KEY |
| IOQM-2023-Q29 | 2023/Q29 | CLEAN_VALIDATED | PRIMARY | sum-product partitions;uniqueness | no | HBCSE_LINKED_MTAI_EMBEDDED_KEY |

## J. Source-independent mathematical trace
Seven anchors independently reconstructed. Mandatory controls: 2025-Q11 uses final official 26, and 2023-Q04 uses the validated x^4 stem; all other anchor answers agree with source authority.
