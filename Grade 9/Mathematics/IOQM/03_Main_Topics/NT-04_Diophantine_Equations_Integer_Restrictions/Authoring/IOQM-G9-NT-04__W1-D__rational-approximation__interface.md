...
microstream_id: W1-D
microstream_title: Exact Rational Approximation
...
# Exact Rational Approximation - Research Interface

## A. Scope boundary
Included: cross multiplication, denominator bounds, coprimality.

Excluded: generic continued fractions or decimal numerical analysis. Overlap mechanisms remain with their declared canonical owners and appear here only as retrieval or a narrow bridge.
...
OWNERSHIP_TARGET: Exact Rational Approximation as part of one integrated topic journey.

## C. Mathematical invariant / governing structure
**scaled rational error qa-pb is an integer, so closeness becomes a discrete gap problem**
