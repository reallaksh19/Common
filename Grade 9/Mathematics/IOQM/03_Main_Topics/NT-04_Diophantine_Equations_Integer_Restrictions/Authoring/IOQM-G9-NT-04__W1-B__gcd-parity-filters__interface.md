...
microstream_id: W1-B
microstream_title: Parity and GCD Filters
...
# Parity and GCD Filters - Research Interface

## A. Scope boundary
Included: parity compatibility, gcd normalization, coprime block use.

Excluded: generic gcd/lcm teaching or full valuation doctrine. Overlap mechanisms remain with their declared canonical owners and appear here only as retrieval or a narrow bridge.
...
OWNERSHIP_TARGET: Parity and GCD Filters as part of one integrated topic journey.

## C. Mathematical invariant / governing structure
**cheap discrete filters should remove impossible factor cases before reconstruction**
