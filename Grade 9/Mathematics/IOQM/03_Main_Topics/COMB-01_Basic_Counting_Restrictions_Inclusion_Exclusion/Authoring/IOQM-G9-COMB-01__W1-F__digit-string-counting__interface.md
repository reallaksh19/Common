...
microstream_id: W1-F
microstream_title: Digit-string counting and arithmetic boundary
...
## A. Scope boundary
Included: counting admissible strings once arithmetic restrictions are known. Excluded: generic recurrence/state evolution, graph-coloring canon and arithmetic digit-rule derivation.
...
counting owns arrangement of admissible digits; arithmetic digit-rule derivation remains with NT-05. The topic router is `DEFINE OBJECT -> IDENTITY/ORDER -> RESTRICTIONS -> CASES/STAGES -> DIRECT/COMPLEMENT/IE -> COUNT -> CHECK`.
...
IOQM-2025-Q05; IOQM-2024-Q02. Exact source/key custody and independent routes are recorded in the source map and audit.
