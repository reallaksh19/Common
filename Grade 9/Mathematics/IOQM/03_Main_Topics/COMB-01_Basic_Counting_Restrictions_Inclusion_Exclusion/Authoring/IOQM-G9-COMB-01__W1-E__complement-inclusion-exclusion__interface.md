...
microstream_id: W1-E
microstream_title: Complement and inclusion-exclusion
...
## A. Scope boundary
Included: universe/complement modeling and overlap correction. Excluded: generic recurrence/state evolution, graph-coloring canon and arithmetic digit-rule derivation.
...
complement uses the same universe; IE repairs repeated membership in overlapping properties. The topic router is `DEFINE OBJECT -> IDENTITY/ORDER -> RESTRICTIONS -> CASES/STAGES -> DIRECT/COMPLEMENT/IE -> COUNT -> CHECK`.
...
IOQM-2025-Q18; IOQM-2025-Q15. Exact source/key custody and independent routes are recorded in the source map and audit.
