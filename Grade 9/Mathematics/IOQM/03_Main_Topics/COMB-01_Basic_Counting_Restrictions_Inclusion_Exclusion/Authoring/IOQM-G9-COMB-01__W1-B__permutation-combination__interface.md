...
microstream_id: W1-B
microstream_title: Permutation and combination derivation
...
## A. Scope boundary
Included: ordered roles/sequences versus unordered selections. Excluded: generic recurrence/state evolution, graph-coloring canon and arithmetic digit-rule derivation.
...
combination counts arise by removing the r! order overcount from ordered selections. The topic router is `DEFINE OBJECT -> IDENTITY/ORDER -> RESTRICTIONS -> CASES/STAGES -> DIRECT/COMPLEMENT/IE -> COUNT -> CHECK`.
...
IOQM-2023-Q17. Exact source/key custody and independent routes are recorded in the source map and audit.
