...
microstream_id: W1-D
microstream_title: Restrictions and position constraints
...
## A. Scope boundary
Included: forbidden/required positions, grouped assignments and restricted injections. Excluded: generic recurrence/state evolution, graph-coloring canon and arithmetic digit-rule derivation.
...
apply the strongest restriction before unrestricted factorial counting when it reduces the state space. The topic router is `DEFINE OBJECT -> IDENTITY/ORDER -> RESTRICTIONS -> CASES/STAGES -> DIRECT/COMPLEMENT/IE -> COUNT -> CHECK`.
...
IOQM-2025-Q15; IOQM-2024-Q02. Exact source/key custody and independent routes are recorded in the source map and audit.
