...
microstream_id: W1-G
microstream_title: Source, symmetry and misconception audit
...
## A. Scope boundary
Included: source custody, independent verification, symmetry normalization and ownership drift. Excluded: generic recurrence/state evolution, graph-coloring canon and arithmetic digit-rule derivation.
...
historical mechanisms are preserved without expanding this topic into recurrence, graph or digit-arithmetic canon. The topic router is `DEFINE OBJECT -> IDENTITY/ORDER -> RESTRICTIONS -> CASES/STAGES -> DIRECT/COMPLEMENT/IE -> COUNT -> CHECK`.
...
all seven required anchors. Exact source/key custody and independent routes are recorded in the source map and audit.
