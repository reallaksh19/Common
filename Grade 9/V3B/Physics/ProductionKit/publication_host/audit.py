...
from v3b.contracts import digest, file_digest, load, require, verify_file
...
def verify_publication(root: Path, expected_basis: str):
    ...
    ctx = read_inputs(plan, baseline, root / "inputs/sources")
