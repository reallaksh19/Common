...
def test_chemistry_registry_schema_and_subtopic_invariants():
    ...
    expected_subtopics = [
        ...
        "CHEM-MATTER-STATES",
        "CHEM-RXN-TYPES-DECOMPOSITION",
        "CHEM-CARBON-COVALENT-BONDING",
        "CHEM-BOND-VSEPR-GEOMETRY",
        "CHEM-THERMO-GIBBS-SPONTANEITY",
        "CHEM-EQUIL-LE-CHATELIER",
        "CHEM-HYDROCARBONS-ALKENE-ADDITION"
    ]
...
def test_mutation_falsification_jee_tier():
    ...
    try:
        ...
        assert err.code == "CHEM_GATE_SCHEMA_VIOLATION"
