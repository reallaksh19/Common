...
class ProductControlConsolidationTests(unittest.TestCase):
    ...
    def test_pr360_migration_has_no_unclassified_generic_control(self):
        ...
        expected = {
            "GENERATION_ORCHESTRATION_CONTRACT",
            "SOURCE_DENOMINATOR_FREEZE",
            "CAPABILITY_TAXONOMY_BREADTH",
            "LOCAL_VISUAL_OBLIGATION_CLOSURE",
            "HELPER_PEDAGOGY_ACTIONABILITY",
            "ANSWER_CUSTODY",
            "FAIL_CLOSED_LEARNER_ROLE_PROJECTION",
            "ROLE_LEVEL_LEGIBILITY_AND_DENSITY",
            "HISTORICAL_EXACT_PRODUCT_CANDIDATE",
        }
