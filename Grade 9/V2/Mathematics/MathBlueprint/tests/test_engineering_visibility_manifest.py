...
def request_for_gate(gate_id: str) -> dict:
    return {
        ...
        "subject": "MATHEMATICS",
        "request_id": "MATH-ENG-REQ-VISIBILITY_TEST",
...
class EngineeringVisibilityManifestTests(unittest.TestCase):
    def build_inputs(self, root: Path):
        ...
        admission = {
            ...
            "subject": "MATHEMATICS",
            "admission_id": "MATH-ENG-DOMAIN-ADMISSION-VISIBILITY_TEST",
            "domain_registry_ref": str((root / "domain_registry.json").resolve()),
            "authorizations": [{
                "authorization_id": "MATH-ENG-AUTH-VISIBILITY_TEST",
            ...
            "subtopic_gate_map": [{
                ...
                "gate_bindings": [{
                    ...
                    "authorization_ref": "MATH-ENG-AUTH-VISIBILITY_TEST",
                }],
            }],
        }
    ...
    def test_visibility_requires_released_product(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaisesRegex(ValueError, "MATH_ENG_VISIBILITY_RELEASE_GATE_REQUIRED"):
