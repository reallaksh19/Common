...
def core2_truth_signature(core2):
    ...
    for p in core2["pages"]:
        rows.append({
            ...
            "source_question_digest":p["source_question_digest"],
            ...
            "verification_route":p["verification_route"],
...
def build_authority_trace(intake, review, scope_model, problem, study_model, core1_info, core2, closure):
    ...
    outputs={
      ...
      "EXPLANATION_REPRESENTATION":[core2["core2_transfer_plan_id"]],
      "WORKED_EXAMPLE":[core1_info["candidate_class"]],
      "CORE1_PCK_LEGALITY":[core1_info["status"]],
      "ORIGINAL_QUESTION_CORE2":[core2["core2_transfer_plan_id"]],
      "HINTS":[core2["core2_transfer_plan_id"]],
...
def run_cold_start(question_set, topic_scope, attempt_set=None, repo_root=None, run_id="MATH-M-K-RUN", fixture_observation_oracle=False):
    ...
    report={
      ...
      "stage_outputs":{
        ...
        "core2_plan_ref":core2["core2_transfer_plan_id"],"core2_plan_digest":core2["plan_digest"],
      ...
      "coverage_closure":{"assessment_row_count":len(closure["assessment_coverage_matrix"]["rows"]),"semantic_gap_count":len(closure["publication_coverage_closure"]["gap_report"]),"publication_closure_status":closure["publication_coverage_closure"]["publication_closure_status"]},
      "authority_trace":[],
