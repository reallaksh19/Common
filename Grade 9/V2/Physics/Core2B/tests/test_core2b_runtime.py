...
from core1b_runtime import build_release_receipt,digest_without as c1_digest_without
...
current=S["retrieval_state"];new=update_retrieval_state(current,attempt);assert "VY_T_GRAPH" not in new["representation_success"]
correct=copy.deepcopy(attempt);correct["event_id"]="C2B-ATTEMPT-0002";correct["outcome"]="CORRECT";correct["event_digest"]=digest_without(correct,"event_digest");new2=update_retrieval_state(new,correct);assert "VY_T_GRAPH" in new2["representation_success"]
print("Physics Core2B runtime tests: PASS (11 guards + real Core2A/Core1B integration)")
