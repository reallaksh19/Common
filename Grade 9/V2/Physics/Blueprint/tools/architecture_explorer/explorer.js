...
function renderDependencyGraph() {
  ...
  const subsystems = [
    ...
    { id: "ENG", label: "Physics Engineering Gates", x: 300, y: 100, color: "#34d399" },
...
function renderGapsView() {
  ...
  container.innerHTML = `
    <div class="gap-alert-card">
      <div class="gap-alert-title">Schemas Without Dedicated Validator (${gaps.schemas_without_validator?.length || 0})</div>
      <p style="font-size:0.85rem; margin-bottom:6px;">These schemas are defined in <code>contracts/</code> but have no dedicated <code>validate_*.py</code> validator in <code>engine/</code>:</p>
      <ul class="gap-list">
