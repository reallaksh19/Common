...
class CoreTests(unittest.TestCase):
    ...
    def test_terminal_repo_has_empty_frontier_and_no_active_ep(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            cp={"schema_version":"relay-v2.5","checkpoint_id":"CP-1","ep_id":"EP-1","roadmap_basis":{"roadmap_id":"RM-T","revision":"RM-0001"},"implementation_result":{},"acceptance_results":[],"validation_results":[],"quality_findings":[],"discoveries":[],"roadmap_reconciliation":{"result":"STATUS_UPDATE"},"successor":{"mode":"NONE","frontier_work_package":None,"ep_id":None,"parallel_plan":None,"lanes":[]}}
