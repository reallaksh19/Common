...
OWNER_HEADINGS=("# Owner Roadmap","## Executive state","## Phase status","## Active work","## Newly discovered work","## What can happen now","## What changed","## What this work is for","## What will not change without authority","## Evidence and confidence","## Quality and known risks","## Roadmap and progress","## Delivery","## Action required outside this environment","## Owner decisions","## Recommended forward sequence","## Roadmap revision history","## What would stop progress")
