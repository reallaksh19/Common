...
def validate(root:Path):
    ...
    if src.get("roadmap_revision")!=s["roadmap"]["revision"]:e.append("active EP was generated from a stale roadmap revision")
    ...
    if wid not in compute_frontier(r):e.append(f"active EP work package {wid} is no longer on computed frontier")
