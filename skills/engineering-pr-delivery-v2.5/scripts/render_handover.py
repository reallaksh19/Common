...
def render(root:Path):
    ...
    lines+=["","## Relay",f"- Replacement agent can recover this state immediately? **{'YES' if s.get('chat_context_required') is False else 'NO'}**",f"- Conversation context required? **{'NO' if s.get('chat_context_required') is False else 'YES'}**"]
