...
def _stable_task(task_snapshot: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "programme_progress": _mapping(task_snapshot.get("programme_progress")),
        "work_issue_progress": _mapping(task_snapshot.get("work_issue_progress")),
        "plan_progress": _mapping(task_snapshot.get("plan_progress")),
        "task_acceptance_progress": _mapping(task_snapshot.get("task_acceptance_progress")),
        "verification": _mapping(task_snapshot.get("verification")),
        "delivery": _mapping(task_snapshot.get("delivery")),
        "completion": _mapping(task_snapshot.get("completion")),
