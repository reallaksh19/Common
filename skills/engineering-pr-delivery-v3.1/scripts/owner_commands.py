...
WORKFLOWS = {
    "WHAT_NEXT": {
        ...
        "steps": [
            ...
            "Separate programme frontier from execution blockers, acceptance debt, delivery/governance debt and deferred/future work.",
            "Report the first still-real frontier and why; do not admit or execute it.",
        ],
    ...
    "PROCEED_NEXT": {
        ...
        "steps": [
            ...
            "Use ROADMAP ordering and the canonical next programme frontier.",
            "If the current EP is still the justified frontier, continue it; otherwise do not revive it.",
            "If IDLE and a different task is next, admit exactly that governed task before execution.",
    ...
    "PROCEED_NEXT_COMPLEX": {
        ...
        "steps": [
            ...
            "Challenge whether the apparent next patch is actually the next programme obligation.",
