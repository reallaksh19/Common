...
WORKFLOWS = {
    "WHAT_NEXT": {
        ...
        "steps": [
            ...
            "If the selected frontier is blocked, report the blocker and do not laterally jump to another live branch without a new Owner/programme selection.",
    ...
    "PROCEED_NEXT": {
        ...
        "steps": [
            ...
            "If the selected frontier is execution-blocked, stop on that blocker; do not switch to another live branch merely to stay busy.",
